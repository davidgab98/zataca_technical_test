...
- Por último, aunque no aporta robustez como tal, se podría implementar la funcionalidad de infinite scroll (paginación) en la lista de Posts. Así, pediríamos los items siguientes desde el repositorio al detectar que se ha llegado al final de la página y los añadiríamos a la lista a mostrar. 
